...
import '../details/pdf_fees_screen.dart';
...
class RecordScreen extends StatelessWidget {
  ...
  final Uri studentSchedule =
      Uri.parse('http://92.253.124.162/student/schedule');
  @override
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    itemDashboard('موقع التسجيل', 'assets/images/anu.jpg',
                        () => launchUrl(anuUrl), context),
                    itemDashboard('خدمات الطالب', 'assets/images/services.jpg',
                        () => launchUrl(studentServices), context),
                  ],
                ),
              ],
            ),
