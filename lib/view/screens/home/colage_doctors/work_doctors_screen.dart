import 'package:anu_app/data/model/college_of_works.dart';
...
class WorksDoctorsScreen extends StatelessWidget {
  const WorksDoctorsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    List<CollegeOfWorks> softDoc = softDocs;
