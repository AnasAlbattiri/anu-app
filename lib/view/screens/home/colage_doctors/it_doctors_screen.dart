...
import '../../../../data/model/software_docs_model.dart';
import '../../details/doctor_details_screen.dart';

class ItDoctorsScreen extends StatelessWidget {
  const ItDoctorsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    List<SoftwareDocsModel> softDoc = softDocs;
