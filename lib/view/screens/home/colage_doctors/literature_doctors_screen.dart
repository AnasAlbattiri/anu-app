import 'package:anu_app/data/model/college_of_Literature.dart';
...
class LiteratureDoctorsScreen extends StatelessWidget {
  const LiteratureDoctorsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    List<CollegeOfLiterature> softDoc = softDocs;
