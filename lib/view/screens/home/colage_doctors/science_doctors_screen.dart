import 'package:anu_app/data/model/college_of_science.dart';
...
class ScienceDoctorsScreen extends StatelessWidget {
  const ScienceDoctorsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    List<CollegeOfScience> softDoc = softDocs;
