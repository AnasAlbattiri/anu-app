import 'package:anu_app/data/model/college_of_educational_sciences.dart';
import 'package:anu_app/utils/constants.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import '../../details/doctor_details_screen.dart';

class EducationalScienceDoctorsScreen extends StatelessWidget {
  const EducationalScienceDoctorsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    List<CollegeOfEducationalScience> softDoc = softDocs;
